...
class Unban extends Command {
    constructor(bot) {
        ...
        this.run = async (msg, args) => {
            ...
            const reason = `[${msg.author.username.replace(/[^\x00-\x7F]/g, "")}#${msg.author.discriminator}] - ${msg.content.split(' ').slice(2).join(' ') || `[${msg.author.username.replace(/[^\x00-\x7F]/g, "")}#${msg.author.discriminator}] -  unban command issued (no reason given)`}`;
